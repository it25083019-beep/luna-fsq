...
def crisis_script(user: Dict[str, Any]) -> Dict[str, Any]:
    ...
    voices = {
        "luna": {
            ...
            "done": "よく戻ってきた。いのちの電話もある。急がなくていい。",
        },
        "luno": {
        ...
        "ren": {
            ...
            "done": "戻ったな。よくやった。いのちの電話、番号は置いてある。",
        },
        "hachi": {
